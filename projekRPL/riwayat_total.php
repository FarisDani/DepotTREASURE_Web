	...
	<nav class="navbar navbar-expand-lg" style="background-color: #1570ef; margin-bottom: 100px;" >
		  <div class="container-fluid" style="padding:2% 0 2% 0%; font-size: 15pt">
		    ...
		    <div class="collapse navbar-collapse" id="navbarNavDropdown" style="padding-left: 45%">
		      <ul class="navbar-nav">
		        <li class="nav-item">
		          <a class="nav-link active" aria-current="page" href="index_admin.php" style="color: white; margin-right: 10px;">Home</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" href="index_admin.php" style="color: white"> Edit Produk</a>
		        </li>
       ...
       <section class="vh-100">
        <div class="container text-start pt-1">
            <div class="row pt-1">
                <div class="col-7">
                    <h3 style="margin-left: 200px;">Riwayat Penjualan Total</h3>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" action="riwayat_total_delete.php">                    
                                                <input type="hidden" name="idhapus" id="<?= $data['orderstatusid'] ?>" value="<?= $data['orderstatusid'] ?>">
